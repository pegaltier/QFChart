...
## [0.8.7] - 2026-04-12 - Polyline `bar_index` Guard

### Fixed

- **`PolylineRenderer` (`xloc.bar_index`)**: When a point’s **`index`** is **`null`**, **`undefined`**, or **`NaN`**, the polyline segment is **skipped** instead of defaulting to **`0`**, which could misplace or corrupt paths on the chart.
